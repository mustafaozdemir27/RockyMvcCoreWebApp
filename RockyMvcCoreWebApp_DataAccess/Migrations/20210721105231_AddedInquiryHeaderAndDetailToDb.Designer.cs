...
namespace RockyMvcCoreWebApp_DataAccess.Migrations
{
    ...
    [Migration("20210721105231_AddedInquiryHeaderAndDetailToDb")]
    partial class AddedInquiryHeaderAndDetailToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RockyMvcCoreWebApp_Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RockyMvcCoreWebApp_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RockyMvcCoreWebApp_Models.InquiryDetail", b =>
                {
                    b.HasOne("RockyMvcCoreWebApp_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RockyMvcCoreWebApp_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("RockyMvcCoreWebApp_Models.InquiryHeader", b =>
                {
                    b.HasOne("RockyMvcCoreWebApp_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
